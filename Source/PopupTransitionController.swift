...
class PopupTransitionController: UIViewController, AlertTransitionController, UIViewControllerAnimatedTransitioning {
    ...
    private func animateShowTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.3, options: .curveEaseIn, animations: { () -> Void in
